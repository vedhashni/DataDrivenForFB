    ...
    { 
        ...
        public static void email_send()
        {
            try
            {
                ...
                attachment = new Attachment(@"C:\Users\vedhashni.v\source\repos\DataDrivenForFB\DataDrivenForFB\Report\index.html");
            ...
            {
                throw new CustomException(CustomException.ExceptionType.FileNotFoundException, "file not found in the given path");
            }
        }
    }
}
